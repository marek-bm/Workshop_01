...
public class Main2 {
    ...
    static void lottoGame() {
        ...
        lottoResult(lotto,user);

    }



    //method generating table with 6 random lotto numbers
    ...
    //Method initializing scanner and asking user for input
    ...
    //method creating 6 lotto numbers provided by user
    ...
    //method evaluating how numbers were guessed correctly
    static void lottoResult(int[] lotto, int[] user){
        int counter=0;
